...
The shared DTOs live in `src/ai_rpg/core/contracts.py`.

## Ownership split

- Orchestrator branch: `src/ai_rpg/cli`, `src/ai_rpg/game/action_evaluator.py`, `src/ai_rpg/game/context_builder.py`, `src/ai_rpg/llm`, migrations, and cross-system tests.
- Combat branch: `src/ai_rpg/game/combat.py`, `src/ai_rpg/game/combat_rules.py`, `src/ai_rpg/db/combat_repo.py`, and combat tests.
- Simulation branch: `src/ai_rpg/game/simulation.py`, `src/ai_rpg/game/time.py`, `src/ai_rpg/db/event_repo.py`, and simulation tests.
- Scenario branch: `src/ai_rpg/scenarios`, `src/ai_rpg/cli/scenario_menu.py`, and scenario tests.

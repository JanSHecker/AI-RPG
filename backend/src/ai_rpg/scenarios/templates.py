...
from ai_rpg.core.contracts import ActionAttribute, ActionResolutionMode, EntityType, EventType, QuestStatus
        ...
        "actions": [
            {
                "id": "action.travel",
                "name": "Travel",
                "description": "Move between connected places in the local area.",
                "aliases": ["go", "go to", "travel", "travel to", "head to", "move to"],
            ...
            },
            {
                "id": "action.talk",
                "name": "Talk",
                "description": "Speak with someone nearby and try to shape the conversation.",
                "aliases": ["talk", "talk to", "speak to", "chat with", "ask"],
                "relevant_attribute": ActionAttribute.DIPLOMACY,
                "difficulty": 10,
                "action_point_cost": 10,
                "resolution_mode": ActionResolutionMode.DETERMINISTIC,
                "handler_key": "talk",
            ...
            },
            {
                "id": "action.rest",
                "name": "Rest",
                "description": "Stop for the day and recover your action points.",
                "aliases": ["wait", "rest", "camp", "sleep", "pass time"],
                "relevant_attribute": ActionAttribute.CONSTITUTION,
                "difficulty": 0,
                "action_point_cost": 0,
                "resolution_mode": ActionResolutionMode.DETERMINISTIC,
                "handler_key": "rest",
            ...
            {
                "id": "action.attack_hostile",
                "name": "Attack",
                "description": "Open a fight against a hostile target that is already present.",
                "aliases": ["attack", "strike", "fight", "kill", "swing at"],
                "relevant_attribute": ActionAttribute.MELEE,
                "difficulty": 10,
                "action_point_cost": 20,
                "resolution_mode": ActionResolutionMode.DETERMINISTIC,
                "handler_key": "attack_hostile",
                "created_by_llm": False,
            },
        ],
        "inventories": [
